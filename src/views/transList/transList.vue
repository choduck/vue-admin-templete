    ...
    <el-form ref="form" :model="form" label-width="120px">
      <el-form-item label="작업일자">
         <el-date-picker  
            ...
            type="date"
            placeholder="Start day" value-format="yyyy-MM-dd" @change="handleDateChange">
          </el-date-picker>
          <span class="demonstration"> ~ </span>
          <el-date-picker 
            v-model="form.datepicker2"
            type="date"
            placeholder="End day" value-format="yyyy-MM-dd" @change="handleDateChange" >
          </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="Activity name">
         ...
         <el-col :span="10">
          <el-input v-model="form.name" @keyup.enter.native="fetchData" placeholder="검색어를 입력하세요" />
         </el-col>
